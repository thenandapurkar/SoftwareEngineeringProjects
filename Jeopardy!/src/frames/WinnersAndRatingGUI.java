...
public class WinnersAndRatingGUI extends JFrame{
	...
	protected void createRatingLabel(){
		currentRatingLabel = new JLabel(gameData.getGameFile().getNumberOfRatings() == -1 ? "no rating" : "current average rating : " + gameData.getGameFile().getAverageRating()+"/5", JLabel.CENTER);
	}
