...
private static HashMap<Class<? extends Message>, Action> actionMap;
	...
	public ActionFactory(){
		...
		if (actionMap == null){
			...
			actionMap.put(ForfeitTurnMessage.class, new ForfeitTurnAction());
			actionMap.put(BuzzInPeriodMessage.class, new BuzzInPeriodAction());
			actionMap.put(QuestionExpiredMessage.class, new QuestionExpiredAction());
			actionMap.put(MainGuiCountDownMessage.class, new MainGuiCountDownAction());
			actionMap.put(QuestionTimerMessage.class, new QuestionTimerAction());
		}
	}
